...
- **Siguiente fase: zona de estudio** (sección de estudio con chat; ver `proyectos/zona-de-estudio.md` e `ideas/bandeja.md`). **Brainstorming empezado el 2026-09-24** (clasificado como arquitectónico: proceso completo). Diego ya confirmó este entendimiento:
  ...
  - **Siguiente pregunta, la decisión clave:** la app no tiene servidor y la suscripción de Claude no se puede usar desde una web propia. Un chat que conteste "solo" dentro de la app necesita la API de Claude, que se paga por uso y rompe el 0 €. Hay que explicarle las alternativas gratis con la suscripción, cada una con sus pegas (p. ej., Claude Code escribe en `my-context` las explicaciones y pizarras y la app las muestra), y dejarle elegir. Usar el acompañante visual para los bocetos de la pizarra, solo cuando haga falta (a Diego le preocupa el gasto). **En esa misma actualización, incluir estos pulidos pendientes** para dejar una versión definitiva:
