...
## Estado actual
Última actualización: 2026-09-26 (v1.4 parte 1 hecha, falta que Diego la pruebe).
...
- **Versión 1.4 (dibujo a mano), parte 1 hecha** en la rama `v1.4-dibujo` (sin publicar): herramientas (lápiz con presión, subrayador, formas, lazo, borrador de trazos y goma, texto, colores, grosores, deshacer/rehacer y toques de Procreate), capas (la de Claude con todo lo suyo y las de Diego) y copiar/pegar, en la zona de estudio del PC y en las pizarras del historial (móvil, iPad, web). Diseño: `docs/superpowers/specs/2026-09-26-dibujo-a-mano-design.md`. Plan: `docs/superpowers/plans/2026-09-26-dibujo-a-mano-parte-1.md`. Registro: `.superpowers/sdd/2026-09-26-dibujo-a-mano-parte-1/progress.md`.
